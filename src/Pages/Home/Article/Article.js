          ...
          <Grid item xs={12} md={5}>
            ...
            <div className='left-article-box'>
              ...
              <div className='left-article-box-text a'>
                <h1>Follow The Corona Safety Guideline While Shopping</h1> <br />
